...
// Niente cache per dati dinamici
    ...
    <div className="relative flex size-full min-h-screen flex-col bg-[#f8f9fc] justify-between font-sans">
      <div className="pb-32">
        ...
        <div className="flex items-center p-4">
          <Link
            href="/"
            className="text-[#0e121b] p-2 -ml-2"
          ...
          <div className="grid grid-cols-2 gap-4 text-center">
            <div>
              ...
              <p className="font-bold text-lg">
                {formatCurrencyEUR(product.est_value_eur)}
              </p>
            </div>
            <div>
      ...
      {/* CTA: foglio con i pacchetti */}
      <CheckoutSheet slug={product.slug} name={product.name} />
    </div>
  );
}
